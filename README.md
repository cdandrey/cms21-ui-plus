...
|---|---|---:|---|
| **Part repairability badge** | `showPartRepairabilityIndicators` | `true` | Adds a white wrench to repairable loose-part rows in the inventory, warehouse, barn, junkyard, scrap, scrap-upgrade and mechanical/body repair lists. When CMS21 Gameplay+ is also installed, its optional brake-drum repair support is reflected without making either mod a required dependency of the other. |
