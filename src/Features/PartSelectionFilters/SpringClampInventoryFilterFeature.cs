    ...
    internal static class SpringClampInventoryFilterFeature
    {
        ...
        private static readonly AssemblyPartSelectionFilterController Controller =
            new AssemblyPartSelectionFilterController(
                ChoosePartUpWindowType.SpringConnect,
                ChoosePartUpWindowType.SpringSeparate, IsEnabled, ShouldResetOnExit,
                "SpringClamp", "Hint_ResetSpringClampFilters", "QSpringClampFilter",
                "QSpringClampSeparateEmptyState", "QSpringClampSelectionPrompt",
                "QSpringClampAssemblyEmptyState", "SpringClampInventoryFilter",
                "spring-clamp", true);
            ...
            ref int selectedIndex)
        {
            ...
            return new DownWindowShowState {
                IsSpringWindow = state.IsTargetWindow,
            ...
            DownWindowShowState state)
        {
            Controller.OnWindowShown(window,
                new AssemblyPartSelectionFilterController.DownWindowShowState {
                    IsTargetWindow = state.IsSpringWindow,
                    NeedsEmptyRefresh = state.NeedsEmptyRefresh,
                });
        }
        ...
        private static bool ShouldResetOnExit()
        {
            return Main.SettingsEntry != null &&
                Main.SettingsEntry.Value.resetSpringClampInventoryFiltersOnExit;
        }
